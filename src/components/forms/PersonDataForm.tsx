...
const PersonDataForm = ({ form, prefix, title }: Props) => {
  const fields: { name: FieldPath<FormData>; label: string }[] = [
    ...
    { name: `${prefix}.endereco`, label: "Endereço" },
    { name: `${prefix}.bairro`, label: "Bairro" },
    { name: `${prefix}.cidade`, label: "Cidade" },
    { name: `${prefix}.estado`, label: "Estado" },
    { name: `${prefix}.cep`, label: "CEP" },
